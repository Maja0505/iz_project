...
prerequisites(Infiltration_of_Software_Development_Environment, The_victim_must_have_a_system_running_exploitable_applications_and/or_a_vulnerable_configuration).
...
prerequisites(Infiltration_of_Hardware_Development_Environment, The_victim_must_have_a_system_running_exploitable_applications_and/or_a_vulnerable_configuration).
...
prerequisites(Documentation_Alteration_to_Circumvent_Dial-down, Advanced_knowledge_of_internal_software_and_hardware_components_within_manufacturers_development_environment).
prerequisites(Documentation_Alteration_to_Circumvent_Dial-down, Access_to_the_manufacturers_documentation).
...
prerequisites(Documentation_Alteration_to_Produce_Under-performing_Systems, Access_to_the_manufacturers_documentation).
